import { Box, LayoutGrid, LogOut, User, Users } from 'lucide-react';
...
export const Sidebar = ({
  ...
  const isSharedPage = location.pathname === '/received';
      ...
      <nav className="flex-1 px-4 py-6 space-y-2">
        <div
          ...
          className={`flex items-center gap-3 px-4 py-3 rounded-xl cursor-pointer transition-colors ${
            !selectedCompanyId && !isSharedPage
        ...
        >
          <Users size={20} />
          <span className="hidden lg:block font-medium">Поділилися зі мною</span>
        </div>
